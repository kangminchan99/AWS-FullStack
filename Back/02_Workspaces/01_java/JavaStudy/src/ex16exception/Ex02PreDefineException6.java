...
public class Ex02PreDefineException6 {
    ...
    public static void main(String[] args)  {
        /*
        Object클래스를 단독적으로 생성한 경우 다른 클래스와의 상속관계가 전혀 없는
        상태이므로 이 상태에서는 형 변환을 할 수 없어 예외가 발생한다.
         */
    ...
    /*
    String 인스턴스가 인수로 전달되면서 매개변수를 통해 Object로 자동 형변환되므로 여기에서 상속관계가 확인된다.
    매개변수 o는 원래 String 타입이었으므로 instance of 를 통해 String임을 확인할 수 있고 이경우에는 다운캐스팅이
    가능하게 된다.
     */
